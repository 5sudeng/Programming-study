...
//////////// Priority Queue ////////////////
// return element of S with the largest key (highest priority)
...
// remove and return the element of S with the largest key
...
// increase the value of element i's key to the new value key, which is assumed to be at least as large as i's current key value
